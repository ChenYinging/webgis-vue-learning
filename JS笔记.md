...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233311899.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233325467.png) 

 

高阶函数也可以返回函数。这对于基于更通用的函数创建特化函数特别有用。这个概念通常被称为函数工厂。

![img](C:\Users\syrjb\AppData\Local\Temp\1774233355755.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233386420.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233392193.png) 

第二个参数是当前正在处理的元素的索引。![77423355768](C:\Users\syrjb\AppData\Local\Temp\1774233557681.png)

第三个参数是调用 map 的数组。

![img](C:\Users\syrjb\AppData\Local\Temp\1774233471458.png) 

 

### **4.filter()**

filter 方法用于创建一个包含通过指定测试的元素的新数组，使其在根据条件有选择地提取项时非常有用。![77423362529](C:\Users\syrjb\AppData\Local\Temp\1774233625293.png)
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233642918.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233657303.png) 

![img](C:\Users\syrjb\AppData\Local\Temp\1774233661897.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233675654.png) 

compareFunction 是一个可选的参数，用于指定定义排序顺序的函数。稍后我们将查看如何在排序数字时使用比较函数。

![img](C:\Users\syrjb\AppData\Local\Temp\1774233683087.png) 

 

![img](C:\Users\syrjb\AppData\Local\Temp\1774233687308.png) 

 sort 方法将元素转换为字串，然后比较它们的 UTF-16 码元序列值。

![img](C:\Users\syrjb\AppData\Local\Temp\1774233695806.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233720219.png) 

当 every() 检查所有元素是否通过测试时，some() 检查是否至少有一个元素通过测试。some() 方法一旦找到通过测试的元素就返回 true。如果没有元素通过测试，则返回 false。

![img](C:\Users\syrjb\AppData\Local\Temp\1774233711591.png) 
...
HTML script 元素中的 async 和 defer 属性在 JavaScript 文件如何在网页中装载和执行方面起着关键作用。![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml22460\wps1.jpg)![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml22460\wps2.jpg)
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233797184.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233809299.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233820611.png) 

在这段代码中，我们正在向 https://api.example.com/data 发起一个 GET 请求。现在，请注意你不能直接使用这些数据，你必须将响应转换为 JSON 形式。只有这样你才能在你的项目中任何地方使用它。

![img](C:\Users\syrjb\AppData\Local\Temp\1774233825615.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233831538.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233839209.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233846329.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233852850.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233860096.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233867867.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233879733.png) 
...
![img](C:\Users\syrjb\AppData\Local\Temp\1774233884819.png) 
...
![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml10812\wps1.jpg) 
...
![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml10812\wps2.jpg) 
...
![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml10812\wps3.jpg) 

#### **3. PUT 请求**

PUT请求用于更新服务器上的数据。数据在请求体中传递。

![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml10812\wps4.jpg) 

#### **4. DELETE 请求**

DELETE请求用于删除服务器上的数据。

![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml10812\wps5.jpg) 

### **三、处理响应**

在Axios中，响应数据通常通过.then()方法处理。

![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml10812\wps6.jpg) 

### **四、错误处理**

在处理HTTP请求时，错误处理是非常重要的。Axios提供了多种方法来捕获和处理错误。

![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml10812\wps7.jpg) 
...
![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml10812\wps8.jpg) 

#### **2. 响应拦截器**

响应拦截器可以在响应到达客户端之前对其进行修改。![img](file:///C:\Users\syrjb\AppData\Local\Temp\ksohtml10812\wps9.jpg)
